...
func (repo *roleRepository) GetPermissionGroupByID(id uuid.UUID) (permissionGroup *models.PermissionGroup, err error) {
	...
	err = repo.Conn.QueryRow(query, id).Scan(
		&permissionGroup.ID,
...
func (repo *roleRepository) GetIndexPermissionGroup(req request.PageRequest) (permissionGroups []models.PermissionGroup, total int, err error) {
...
func (repo *roleRepository) GetAllPermissionGroup() (permissionGroups []models.PermissionGroup, err error) {
...
func (repo *roleRepository) CountPermissionGroup() (count *int, err error) {
...
func (repo *roleRepository) PermissionGroupNameIsNotDuplicated(name string, excludedId uuid.UUID) (bool, error) {
	baseQuery := `SELECT 
			COUNT(*)
		FROM 
			permission_groups
...
func (repo *roleRepository) GetDuplicatedPermissionGroup(name string, excludedId uuid.UUID) (permissionGroup *models.PermissionGroup, err error) {
	baseQuery := `SELECT 
